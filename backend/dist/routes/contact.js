...
const RECAPTCHA_SITE_KEY = process.env.RECAPTCHA_SITE_KEY || '6LfBvLgsAAAAAH7UGfOG-Nxz1XwOsKmX77HYMfbR';
...
function isSpam(name, message, email) {
    ...
    if (message.length > 20 && upperCount / message.length > 0.5)
        return true;
    return false;
}
